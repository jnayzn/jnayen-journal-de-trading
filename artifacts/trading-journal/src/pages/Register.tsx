        ...
        <Card className="border-border/50 shadow-2xl bg-card/80 backdrop-blur-xl">
          ...
          <CardContent>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          {...field} 
                          className="bg-background/50 font-mono border-border/50 focus-visible:ring-primary/50 h-11"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground">
              Already have access?{" "}
              <Link href="/login" className="text-primary hover:underline hover:text-primary/80 font-mono uppercase text-xs tracking-wider transition-colors">
                Initialize Session
              </Link>
            </div>
          </CardContent>
